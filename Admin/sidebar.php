...
echo $filename;
$productmenu = array('addproduct.php','manageProduct.php',
                     'categories.php','tags.php','tags.php');
...
<ul>
<li><a <?php if($filename == "addproduct.php") :?>class="current"
<?php endif; ?>href="addproduct.php">Add Product</a></li>
<li><a <?php if($filename == "manageProducts.php") :?>class="current"
<?php endif; ?>href="manageProduct.php">Manage Product</a></li> 
...
<li>
<a href="#" class="nav-top-item <?php if(in_array($filename, $usermenu) ) : ?> 
current 
<?php endif;?>">
Users
</a>
<ul>
<li><a <?php if ($filename == "addUser.php" ) :?>
class="current"
<?php endif; ?> href="addUser.php">Add User</a></li>
<li><a <?php if ($filename == "manageUser.php" ) :?>
class="current"
<?php endif; ?> href="manageUser.php">Manage User</a></li>
</ul>
</li>
