          ...
          <div class="aa-header-top-area">
            ...
            <div class="aa-header-top-left">
              ...
              <div class="aa-language">
                <div class="dropdown">
                  <a class="btn dropdown-toggle" href="#" type=
                  "button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup=
            ...
            if (!empty($_SESSION['cart'])) {
                ...
                ?>
                  <li>
                    ...
                    <?php echo '<img src="Admin/images/' . $value['image'] . '">' ?>
                    </a>
                      <div class="aa-cartbox-info">
                      <h4><a href="#"><?php echo $value['name']?></a></h4>
                      <p><?php echo $value['quantity']?> x 
                    <?php echo $value['pricee']?></p>
                    </div>
                    <a class="aa-remove-product" href="deleteproduct.php?delid=<?php echo $value['id']?>">
                    <span class="fa fa-times"></span></a>
                  </li>  
                <?php }
            } else {
                echo "<h3 style='color:red;'>CART IS EMPTY</h3>";
            } ?>                 
                  <li>
                <?php
                  $total = 0;
                ...
                <a class="aa-cartbox-checkout 
                aa-primary-btn" href="checkout.php">Checkout</a>
              </div>
            </div>
            <!-- / cart box -->
            <!-- search box -->
