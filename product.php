              ...
              <ul class="aa-product-catg">
                ...
                <li>
                  <figure>
                    ...
                    <a class="aa-add-card-btn"href="addproduct.php?pid=<?php echo $row['id']?>"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                    <figcaption>
                  ...
                  <div class="aa-product-hvr-content">
                    <a href="#" data-toggle2="tooltip" data-id=<?php echo $row['id']?>
                     data-placement="top" title="Quick View"
                      data-toggle="modal" data-target="#quick-view-modal" class="quick">
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <?php
                    ...
                    while ($row = $result->fetch_assoc()) {
                            ?>
                <a href="product.php?cid=<?php echo $row['colorid'];?>"><input type = "hidden" name="color" value="<?php echo $row['colorid'] ?>"
