                        ...
                        aa-product-view-slider">                                
                          <div class="simpleLens-gallery-container" id="demo-1">
                            ...
                            <div class="simpleLens-thumbnails-container">
                                ...
                                <a href="#" class="simpleLens-thumbnail-wrapper"
                                    data-lens-
                                    image="img/view-slider/large/polo-shirt-3.png"
                                    data-big-
                                    image="img/view-slider/medium/polo-shirt-3.png">
                                    <img src=
            ...
            <nav>
              <ul class="pagination">
                <li
                    ...
                    ?>
                  ><a href="product.php?page=<?php echo $page-1 ?>
                  " aria-label="Previous">
                  ...
                  <a href="product.php?page=<?php echo $i;?>">
                    <?php echo $i;?></a></li>
                    <?php
                    }
                    ?>
        ...
        <aside class="aa-sidebar">
          ...
          <div class="aa-sidebar-widget">
            <h3>Category</h3>
              ...
              <ul class="aa-catg-nav">
                <li><a href="product.php?id=<?php echo $row['catid']?>
                " class="category" >
          ...
          <div class="aa-sidebar-widget">
            ...
            <div class="tag-cloud">
                ...
                while ($row = $result->fetch_assoc()) {
                ?>
              <a href="product.php?tagId=<?php echo $row['tagId']?>">
          ...
          <div class="aa-sidebar-widget">
            ...
            <div class="aa-sidebar-price-range">
              <form action="">
                <div id="skipstep" class="noUi-target noUi-ltr noUi-
                horizontal noUi-background">
                </div>
